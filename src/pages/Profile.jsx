            ...
            <div className="px-8 space-y-12">
                ...
                <section className="bg-brand-dark rounded-[3rem] p-8 text-white relative overflow-hidden">
                    <div className="flex gap-12 relative z-10">
                        <div>
                            <p className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-500 mb-2">Global</p>
                            <h3 className="text-3xl font-black italic">{rankings.length} <span className="text-[10px] uppercase align-middle ml-1">Foodies</span></h3>
                        </div>
                        <div>
